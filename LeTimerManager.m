...
#import "LeTimerManager.h"

@interface LeTimerManager ()
@property (nonatomic, strong) NSMutableDictionary *timerContainer;
@property (nonatomic, strong) NSMutableDictionary *actionBlockCache;
@end

@implementation LeTimerManager

+ (LeTimerManager *)sharedInstance
{
    static LeTimerManager *leTimerManager = nil;
    static dispatch_once_t predicate;
    dispatch_once(&predicate, ^(){
        leTimerManager = [[LeTimerManager alloc] init];
    });
